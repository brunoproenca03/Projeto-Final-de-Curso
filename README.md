...
Este projeto foi desenvolvido no âmbito do Projeto I e Projeto II da Licenciatura em Engenharia Informática no Instituto Politécnico de Castelo Branco, em parceria com os Serviços Municipalizados de Castelo Branco. O foco é modernizar a medição e gestão de água, utilizando tecnologias IoT, NB-IoT e ou LTE-M.
